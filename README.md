...
- 在线访问。访问此链接[web-link-by-github-pages](https://hayao-1111.github.io/CrossWordPuzzle/CrosswordPuzzle_JavascriptVersion/index.html)
- 离线访问。下载目录`CrosswordPuzzle_JavascriptVersion`，双击其中`index.html`即可在本地浏览器体验~
